...
"""
Descripción:
    Uso de Pagodo para obtener información sobre vulnerabilidades y exploits de un host mediante Google Dorks.

    Consulte https://github.com/opsdisk/pagodo para obtener más detalles. Disponible bajo licencia GPL.
"""
